  ...
  <body id="home">
    ...
    <div>
      ...
      <section id="documentation" class="container">
        ...
        <p>Download the ZIP file from the following link: <a href="https://github.com/thepolygroup/polycookiesapp/archive/refs/heads/main.zip" target="_blank">https://github.com/polyfen/polycookiesapp/archive/refs/heads/main.zip</a></p>
...
&lt;script>
  ...
  document.cookie = 'cookiesConsentGranted=true; ' + expires + '; path=/';
&lt;/script>
          </code>
        </pre>
