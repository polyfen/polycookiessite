<header>
  ...
  <nav>
    <a id="github" href="https://github.com/thepolygroup/polycookiesapp" target="_blank" style="margin-right:20px;"><i class="fa-brands fa-github"></i> an open-source project</a>
